...
namespace MyHashSetLib.Reversed //System.Collections.Generic
{
    ...
    public class RHashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, IReadOnlySet<T>
    {
        ...
        public RHashSet() : this((IEqualityComparer<T>?)null) { }

        public RHashSet(IEqualityComparer<T>? comparer)
        {
        ...
        public RHashSet(int capacity) : this(capacity, null) { }

        public RHashSet(IEnumerable<T> collection) : this(collection, null) { }

        public RHashSet(IEnumerable<T> collection, IEqualityComparer<T>? comparer) : this(comparer)
        {
            if (collection == null)
            {
            ...
            if (collection is RHashSet<T> otherAsHashSet && EqualityComparersAreEqual(this, otherAsHashSet))
            {
        ...
        public RHashSet(int capacity, IEqualityComparer<T>? comparer) : this(comparer)
        {
            if (capacity < 0)
            {
        ...
        private void ConstructFrom(RHashSet<T> source)
        {
            if (source.Count == 0)
            {
        ...
        /// <summary>Removes all elements from the <see cref="RHashSet{T}"/> object.</summary>
        public void Clear()
        {
            int count = _count;
            if (count > 0)
        ...
        /// <summary>Determines whether the <see cref="RHashSet{T}"/> contains the specified element.</summary>
        /// <param name="item">The element to locate in the <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object contains the specified element; otherwise, false.</returns>
...
#else
            var bucketIndex = (uint)hashCode % (uint)buckets.Length;
            return ref buckets[bucketIndex];
#endif
        }
        ...
        /// <summary>Adds the specified element to the <see cref="RHashSet{T}"/>.</summary>
        /// <param name="item">The element to add to the set.</param>
        /// <returns>true if the element is added to the <see cref="RHashSet{T}"/> object; false if the element is already present.</returns>
        ...
        /// <summary>Modifies the current <see cref="RHashSet{T}"/> object to contain all elements that are present in itself, the specified collection, or both.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        ...
        /// <summary>Modifies the current <see cref="RHashSet{T}"/> object to contain only elements that are present in that object and in the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        public void IntersectWith(IEnumerable<T> other)
        {
            ...
            if (other is ICollection<T> otherAsCollection)
            {
                ...
                if (other is RHashSet<T> otherAsSet && EqualityComparersAreEqual(this, otherAsSet))
                {
        ...
        /// <summary>Removes all elements in the specified collection from the current <see cref="RHashSet{T}"/> object.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        ...
        /// <summary>Modifies the current <see cref="RHashSet{T}"/> object to contain only elements that are present either in that object or in the specified collection, but not both.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        ...
        /// <summary>Determines whether a <see cref="RHashSet{T}"/> object is a subset of the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object is a subset of <paramref name="other"/>; otherwise, false.</returns>
        ...
        /// <summary>Determines whether a <see cref="RHashSet{T}"/> object is a proper subset of the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object is a proper subset of <paramref name="other"/>; otherwise, false.</returns>
        ...
        /// <summary>Determines whether a <see cref="RHashSet{T}"/> object is a proper superset of the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object is a superset of <paramref name="other"/>; otherwise, false.</returns>
        public bool IsSupersetOf(IEnumerable<T> other)
        {
            ...
            if (other is ICollection<T> otherAsCollection)
            {
                ...
                if (other is RHashSet<T> otherAsSet &&
        ...
        /// <summary>Determines whether a <see cref="RHashSet{T}"/> object is a proper superset of the specified collection.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object is a proper superset of <paramref name="other"/>; otherwise, false.</returns>
        ...
        /// <summary>Determines whether the current <see cref="RHashSet{T}"/> object and a specified collection share common elements.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object and <paramref name="other"/> share at least one common element; otherwise, false.</returns>
        ...
        /// <summary>Determines whether a <see cref="RHashSet{T}"/> object and the specified collection contain the same elements.</summary>
        /// <param name="other">The collection to compare to the current <see cref="RHashSet{T}"/> object.</param>
        /// <returns>true if the <see cref="RHashSet{T}"/> object is equal to <paramref name="other"/>; otherwise, false.</returns>
        ...
        /// <summary>Copies the elements of a <see cref="RHashSet{T}"/> object to an array, starting at the specified array index.</summary>
        ...
        /// <summary>Removes all elements that match the conditions defined by the specified predicate from a <see cref="RHashSet{T}"/> collection.</summary>
        ...
        /// <summary>
        /// Sets the capacity of a <see cref="RHashSet{T}"/> object to the actual number of elements it contains,
        ...
        /// </summary>
        internal bool IsSubsetOfHashSetWithSameComparer(RHashSet<T> other)
        {
        ...
        /// </summary>
        private void IntersectWithHashSetWithSameComparer(RHashSet<T> other)
        {
            Entry[]? entries = _entries;
            for (int i = 0; i < _count; i++)
            {
        ...
        private void SymmetricExceptWithUniqueHashSet(RHashSet<T> other)
        {
            foreach (T item in other)
            {
                if (!Remove(item))
        ...
        /// </summary>
        internal static bool EqualityComparersAreEqual(RHashSet<T> set1, RHashSet<T> set2) => set1.Comparer.Equals(set2.Comparer);
